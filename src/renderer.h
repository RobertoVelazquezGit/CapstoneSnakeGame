...
private:
  ...
  /*
   * The order in which class members are initialized follows the order in which
   * they are declared, not the order in which you initialize them in the
   * constructor.
   *
   * The order of destruction of members of a class does follow the order in
   * which they are declared in the class, not the order in which they are
